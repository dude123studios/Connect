...
from schemas.dm import DmSchema
...
class CommentPaginationSchema(PaginationSchema):
    data = fields.Nested(CommentSchema, attribute='items', many=True)

class DmPaginationSchema(PaginationSchema):
    data = fields.Nested(DmSchema, attribute='items', many=True)
